...
export const metadata: Metadata = {
  ...
  description: "An interactive learning system for post-quantum cryptography. 6 modules, 23 lessons, and eight hands-on labs — from RSA and ECC through Shor's, Mosca's inequality, ML-KEM, ML-DSA, SLH-DSA, and hybrid TLS migration.",
